...
operadoresLogicos(5, 3, 1); //Numero 1 es mayor y positivo
operadoresLogicos(4, -6, 10); //Hay negativos 
operadoresLogicos(3, 5, 8); //9
operadoresLogicos(0, 0, 0); //Error
operadoresLogicos(0, 0, 4); //5
operadoresLogicos(3, 9, 5); //false
